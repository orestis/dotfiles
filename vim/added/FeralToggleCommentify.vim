...
function s:FindCommentify() " {{{
	...
	if fileType == 'n' || fileType == 'cs' || fileType == 'ox' || fileType == 'cpp' || fileType == 'php' || fileType == 'java'
		let commentSymbol_L = '//'
		let commentSymbol_R = ''
...
"		let commentSymbol_R = '*/'
	...
	elseif fileType == 'm4' || fileType == 'config' || fileType == 'automake'
		...
		let commentSymbol_R = ''
	elseif fileType == 'ruby' || fileType == 'python' || fileType == 'perl' || fileType == 'make' || fileType =~ '[^w]sh$' || fileType == 'tcl' || fileType == 'jproperties'
		let commentSymbol_L = '#'
		let commentSymbol_R = ''
	elseif fileType == 'vb' || fileType == 'aspvbs'
		let commentSymbol_L == "'"
